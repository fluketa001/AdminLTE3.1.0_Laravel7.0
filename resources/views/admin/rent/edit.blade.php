...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">แก้ไขข้อมูลค่าเช่า</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin-home') }}">Home</a></li>
              <li class="breadcrumb-item active">แก้ไขข้อมูลค่าเช่า</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-center">
          <div class="col-md-9 box box-primary">
            <form method="POST" action="{{ route('rent-update') }}" enctype="multipart/form-data">
              <div class="box-body">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="month" id="rents_month" name="rents_month" class="form-control" value="<?php echo date('Y-m',strtotime($data->rents_month)); ?>" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <input type="datetime-local" id="rents_datetime" class="form-control" name="rents_datetime" value="<?php echo date('Y-m-d\TH:i',strtotime($data->rents_datetime)); ?>" required>
                  </div>
                </div>

                <div class="form-group row">
                  <div class="offset-4 col-md-6">
                    <img src="{{ asset('slip/'.$data->rents_slip) }}" style="width:100px;">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="file" id="rents_slip" name="rents_slip" class="form-control">
                  </div>
                </div>
